...
import { ViewState, Module, Lesson, Course, Microcredential, Submission, User, SubmissionContent, AlignmentRow, EvidenceArtifact, SubmissionHistoryEntry } from './types';
...
import { Play, CheckCircle, BookOpen, Lock, Trophy, ChevronRight, ChevronLeft, Layout, Menu, GraduationCap, User as UserIcon, Award, Microscope, HelpCircle, Plus, Minus, Check, Bookmark, Filter, Search, FileText, Shield, Clock, BarChart, Upload, Link as LinkIcon, AlertCircle, CheckSquare, Save } from 'lucide-react';
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                ...
                <table className="w-full text-left">
                    ...
                    <tbody className="divide-y divide-gray-100">
                        {submissions.map(sub => (
                            <tr key={sub.id} className="hover:bg-gray-50 transition-colors cursor-pointer" onClick={() => { setCurrentSubmission(sub); setView(ViewState.SUBMISSION_REVIEW); }}>
